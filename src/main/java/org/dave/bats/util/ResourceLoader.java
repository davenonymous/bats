...
ResourceLoader loader = new ResourceLoader(new File(ConfigurationHandler.configDir, "types.d"), "assets/bats/config/types.d/");
...
public class ResourceLoader {
    ...
    public Map<String, InputStream> getResources() {
        ...
        if(DEVELOPMENT) {
            File assetPath = new File(Bats.class.getResource("/" + assetPathName).getFile());
            ...
            URL srcUrl = Bats.class.getResource("/" + assetPathName);
