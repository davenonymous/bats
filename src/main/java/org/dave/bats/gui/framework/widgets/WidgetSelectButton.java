...
import org.dave.bats.gui.framework.event.MouseEnterEvent;
import org.dave.bats.gui.framework.event.MouseExitEvent;
...
public class WidgetSelectButton<T> extends WidgetWithChoiceValue<T> {
    ...
    protected static final ResourceLocation BUTTON_TEXTURES = new ResourceLocation(Bats.MODID, "textures/gui/tabicons.png");
